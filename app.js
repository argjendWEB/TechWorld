...
const PRODUCTS = [
  {
    id: 1, name: 'Quantum Pro Laptop', price: 1499.99,
    category: 'Laptops', badge: 'Best Seller',
    image: 'images/laptop_main.png',
    gallery: ['images/laptop_main.png', 'images/laptop_side.png', 'images/laptop_detail.png'],
    desc: '16" Retina display, M4 Pro chip, 32GB RAM, 1TB SSD.',
    longDesc: 'The Quantum Pro is our most advanced workstation ever. Built with an aerospace-grade titanium chassis and the revolutionary M4 Pro silicon, it delivers up to 40% faster performance than the previous generation. The Liquid XDR display features 1600 nits of peak brightness and a 120Hz ProMotion refresh rate, making it the ultimate tool for developers, designers, and creators who refuse to compromise.',
    features: ['Aerospace Titanium Body', 'M4 Pro 16-Core CPU', 'Liquid XDR Display (120Hz)', '20-Hour Battery Life'],
    reviews: [
      { author: 'Marcus V.', rating: 5, comment: 'Simply the best laptop I have ever owned. The screen is breathtaking.' },
      { author: 'Sarah L.', rating: 4, comment: 'Incredible performance, although a bit heavy for daily travel.' },
      { author: 'James D.', rating: 5, comment: 'The M4 chip handles 8K video editing like it is nothing. A beast.' }
    ]
  },
  {
    id: 2, name: 'NexusPhone X', price: 999.99,
    category: 'Phones', badge: 'New',
    image: 'images/phone_main.png',
    gallery: ['images/phone_main.png', 'images/phone_back.png', 'images/phone_side.png'],
    desc: '6.7" AMOLED 120Hz, 200MP camera, 5000mAh battery.',
    longDesc: 'Experience the future of mobile technology with NexusPhone X. Featuring a stunning 6.7-inch curved AMOLED display and the world\'s first 200MP mobile sensor, it captures details invisible to the human eye. Powered by the NeuralDrive G3 chip, it offers lightning-fast AI processing for photography, gaming, and multitasking.',
    features: ['200MP Ultra-Sensing Camera', 'NeuralDrive G3 Chip', 'Curved AMOLED Display', 'HyperCharge 120W Support'],
    reviews: [
      { author: 'Elena R.', rating: 5, comment: 'The camera quality is absolutely insane. Night mode looks like daylight.' },
      { author: 'Tom H.', rating: 5, comment: 'Switched from my previous flagship and never looked back. The display is fluid.' },
      { author: 'Mia K.', rating: 4, comment: 'Great phone, battery lasts 2 days easy. A bit large for small hands though.' }
    ]
  },
  {
    id: 3, name: 'AeroSound Pro', price: 349.99,
    category: 'Audio', badge: '',
    image: 'images/headphones_main.png',
    gallery: ['images/headphones_main.png', 'images/headphones_side.png', 'images/headphones_detail.png'],
    desc: 'Active noise cancellation, 40hr battery, spatial audio.',
    longDesc: 'AeroSound Pro redefines immersive audio. Using custom-designed 40mm dynamic drivers and our proprietary Adaptive ANC 2.0, these headphones block out 99% of environmental noise. With spatial audio tracking, your movies and music feel like they are happening all around you.',
    features: ['Adaptive ANC 2.0', 'Spatial Audio with Head Tracking', '40-Hour Playback', 'Lossless Wireless Audio'],
    reviews: [
      { author: 'David K.', rating: 5, comment: 'Silence has never sounded this good. Best ANC on the market.' },
      { author: 'Julia W.', rating: 4, comment: 'Great sound, but the case could be more portable.' },
      { author: 'Rob S.', rating: 5, comment: 'The spatial audio is a game changer for movies. Pure cinema.' }
    ]
  },
  {
    id: 4, name: 'VisionX Smart Watch', price: 449.99,
    category: 'Wearables', badge: 'Popular',
    image: 'images/smartwatch_main.png',
    gallery: ['images/smartwatch_main.png', 'images/smartwatch_side.png', 'images/smartwatch_detail.png'],
    desc: 'Always-on display, health monitoring, GPS, 7-day battery.',
    longDesc: 'Your life, synchronized. VisionX is more than a watch—it is a health companion. With real-time EKG monitoring, blood oxygen sensing, and advanced sleep tracking, it provides deep insights into your well-being. The sapphire glass and titanium frame ensure it withstands the toughest environments.',
    features: ['Advanced Health Sensors', 'Sapphire Glass & Titanium', 'Dual-Band GPS', 'Swim-proof (50m)'],
    reviews: [
      { author: 'Chris B.', rating: 5, comment: 'The fitness tracking is incredibly accurate. Love the design.' },
      { author: 'Anna G.', rating: 5, comment: 'The battery actually lasts a full week. Finally a watch that stays alive.' }
    ]
  },
  {
    id: 5, name: 'HyperTab Ultra', price: 799.99,
    category: 'Tablets', badge: '',
    image: 'images/tablet_main.png',
    gallery: ['images/tablet_main.png', 'images/tablet_side.png'],
    desc: '12.9" Liquid display, stylus support, desktop-class performance.',
    longDesc: 'Powerful enough to be your computer. Portable enough to go anywhere. HyperTab Ultra features a gorgeous 12.9-inch Liquid display with extreme color accuracy. Whether you are editing 4K video or sketching your next masterpiece, the desktop-class GPU ensures zero lag.',
    features: ['Liquid Precision Display', 'Ultra-Low Latency Stylus', 'FaceID Unlocking', 'Thunderbolt 4 Port'],
    reviews: [
      { author: 'Mila S.', rating: 5, comment: 'Perfect for my digital art business. The colors are spot on.' },
      { author: 'Lucas P.', rating: 5, comment: 'The stylus feels like paper. No lag at all. Highly recommend.' }
    ]
  },
  {
    id: 6, name: 'GameForce Elite', price: 499.99,
    category: 'Gaming', badge: 'Hot',
    image: 'images/console_main.png',
    gallery: ['images/console_main.png', 'images/console_side.png'],
    desc: '4K gaming at 120fps, 1TB storage, ray tracing.',
    longDesc: 'Unleash the power of next-gen gaming. The GameForce Elite brings true 4K resolution at smooth 120fps to your living room. With dedicated ray-tracing hardware and ultra-fast NVMe storage, load times are a thing of the past. Join millions of players in an ever-expanding ecosystem.',
    features: ['Native 4K 120fps', 'Hardware Ray Tracing', '1TB NVMe Flash Storage', 'Haptic Control Support'],
    reviews: [
      { author: 'GamerX', rating: 5, comment: 'Loading screens are gone! Best purchase of the year.' },
      { author: 'Ben J.', rating: 4, comment: 'Incredible graphics, just wish the controller stayed charged longer.' }
    ]
  },
  {
    id: 7, name: 'UltraView 4K Monitor', price: 699.99,
    category: 'Displays', badge: '',
    image: 'images/monitor_main.png',
    gallery: ['images/monitor_main.png', 'images/monitor_main.png'],
    desc: '32" curved 4K UHD, 165Hz, HDR1000, 1ms response.',
    longDesc: 'See every pixel in stunning clarity. The UltraView 4K is designed for professional competitive gaming and high-fidelity video production. The 1000-nit HDR performance ensures pure blacks and blinding whites, while the 165Hz refresh rate keeps motion blur-free.',
    features: ['32" 4K Curved Panel', '165Hz Fluid Refresh', 'HDR1000 Certified', '1ms GtG Response'],
    reviews: [
      { author: 'Kevin L.', rating: 5, comment: 'Crystal clear and fast. Great for my dual monitor setup.' },
      { author: 'Sophia M.', rating: 5, comment: 'Colors are so vibrant. Makes editing so much easier.' }
    ]
  },
  {
    id: 8, name: 'PulseWave Earbuds', price: 179.99,
    category: 'Audio', badge: 'New',
    image: 'images/earbuds.png',
    gallery: ['images/earbuds.png', 'images/earbuds.png'],
    desc: 'True wireless, adaptive ANC, 30hr total battery.',
    longDesc: 'Compact size, titanic sound. PulseWave Earbuds bring high-end audio to your pocket. Featuring adaptive ANC that adjusts to your surroundings in real-time, they ensure you hear only what matters. The ergonomic design provides a secure fit for all-day comfort.',
    features: ['Adaptive Hybrid ANC', 'Dual-Beamforming Mics', 'IPX4 Water Resistance', 'Wireless Charging Case'],
    reviews: [
      { author: 'Jessica F.', rating: 5, comment: 'Super comfortable and the sound is surprisingly deep.' },
      { author: 'Liam W.', rating: 5, comment: 'Noise cancellation is spooky good. Can hardly hear the train.' }
    ]
  }
];
