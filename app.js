...
const PRODUCTS = [
  {
    id: 1, name: 'Apple MacBook Pro 16" (M3 Max)', price: 3499.00,
    category: 'Laptops', badge: 'Best Seller',
    image: 'images/macbook_pro_16.png',
    gallery: ['images/macbook_pro_16.png', 'images/macbook_pro_16_side.png', 'images/macbook_pro_16_detail.png'],
    desc: 'M3 Max, 36GB Unified Memory, 1TB SSD, Space Black.',
    longDesc: 'The most advanced Mac ever built. Featuring the M3 Max chip, a stunning Liquid Retina XDR display, and up to 22 hours of battery life. Perfect for extreme workflows like 3D rendering and 8K video editing.',
    features: ['M3 Max 14-Core CPU', 'Liquid Retina XDR Display', '36GB Unified Memory', 'Hardware-accelerated ray tracing'],
    reviews: [
      { author: 'Marcus V.', rating: 5, comment: 'Simply the best laptop I have ever owned. The screen is breathtaking.' }
    ]
  },
  {
    id: 2, name: 'Samsung Galaxy S24 Ultra', price: 1299.99,
    category: 'Phones', badge: 'New',
    image: 'images/galaxy_s24_ultra.png',
    gallery: ['images/galaxy_s24_ultra.png', 'images/galaxy_s24_ultra_back.png', 'images/galaxy_s24_ultra_side.png'],
    desc: 'Titanium frame, Galaxy AI, 200MP camera, Snapdragon 8 Gen 3.',
    longDesc: 'Welcome to the era of mobile AI. Empowered by the new Snapdragon 8 Gen 3 for Galaxy, the S24 Ultra features a tough titanium exterior and a flat 6.8" display, delivering the ultimate smartphone experience.',
    features: ['Galaxy AI Integration', 'Titanium Exterior', '200MP Main Camera', 'Built-in S Pen'],
    reviews: [
      { author: 'Elena R.', rating: 5, comment: 'The camera quality is absolutely insane. Night mode looks like daylight.' }
    ]
  },
  {
    id: 3, name: 'Sony WH-1000XM5', price: 398.00,
    category: 'Audio', badge: '',
    image: 'images/sony_wh1000xm5.png',
    gallery: ['images/sony_wh1000xm5.png', 'images/sony_wh1000xm5_side.png', 'images/sony_wh1000xm5_detail.png'],
    desc: 'Industry leading noise cancellation, 30hr battery, multipoint connection.',
    longDesc: 'The WH-1000XM5 headphones rewrite the rules for distraction-free listening. Two processors control 8 microphones for unprecedented noise cancellation and exceptional call quality.',
    features: ['Auto NC Optimizer', 'Precise Voice Pickup Component', 'Multipoint Bluetooth', '30-Hour Battery Life'],
    reviews: [
      { author: 'David K.', rating: 5, comment: 'Silence has never sounded this good. Best ANC on the market.' }
    ]
  },
  {
    id: 4, name: 'Apple Watch Ultra 2', price: 799.00,
    category: 'Wearables', badge: 'Popular',
    image: 'images/apple_watch_ultra_2.png',
    gallery: ['images/apple_watch_ultra_2.png', 'images/apple_watch_ultra_2_side.png', 'images/apple_watch_ultra_2_detail.png'],
    desc: 'Rugged titanium case, precision GPS, 3000 nits display.',
    longDesc: 'The ultimate sports and adventure watch. With a 49mm aerospace-grade titanium case, it boasts the brightest display Apple has ever created, dual-frequency GPS, and up to 36 hours of battery life.',
    features: ['49mm Titanium Case', '3000 Nits Brightness', 'Precision Dual-Frequency GPS', 'Water Resistant 100m'],
    reviews: [
      { author: 'Chris B.', rating: 5, comment: 'The fitness tracking is incredibly accurate. Love the design.' }
    ]
  },
  {
    id: 5, name: 'Apple iPad Pro 13" (M4)', price: 1299.00,
    category: 'Tablets', badge: '',
    image: 'images/ipad_pro_m4.png',
    gallery: ['images/ipad_pro_m4.png', 'images/ipad_pro_m4_side.png'],
    desc: 'Incredibly thin, Ultra Retina XDR display, M4 performance.',
    longDesc: 'The all-new iPad Pro packs astonishing power into an impossibly thin UI. Featuring a spectacular Ultra Retina XDR display with tandem OLED tech, and powered by the outrageous M4 chip.',
    features: ['Ultra Retina XDR (Tandem OLED)', 'Apple M4 Chip', 'Thunderbolt UI', 'Face ID'],
    reviews: [
      { author: 'Mila S.', rating: 5, comment: 'Perfect for my digital art business. The colors are spot on.' }
    ]
  },
  {
    id: 6, name: 'Sony PlayStation 5 Pro', price: 699.99,
    category: 'Gaming', badge: 'Hot',
    image: 'images/ps5_pro.png',
    gallery: ['images/ps5_pro.png'],
    desc: 'Advanced ray tracing, enhanced GPU, PlayStation Spectral Super Resolution.',
    longDesc: 'Experience spectacular gaming worlds with the PlayStation 5 Pro. Unleash incredibly sharp images, insanely high framerates at True 4K, and advanced hardware ray tracing capabilities.',
    features: ['PlayStation Spectral Super Resolution', 'Advanced Ray Tracing', '2TB NVMe SSD', 'High-Fidelity Framerates'],
    reviews: [
      { author: 'GamerX', rating: 5, comment: 'Loading screens are gone! Best purchase of the year.' }
    ]
  },
  {
    id: 7, name: 'Alienware 32" 4K QD-OLED', price: 1199.99,
    category: 'Displays', badge: '',
    image: 'images/alienware_monitor.png',
    gallery: ['images/alienware_monitor.png'],
    desc: '32" 4K Quantum Dot OLED, 240Hz, 0.03ms response.',
    longDesc: 'Experience uncompromised visual fidelity. The Alienware AW3225QF is the world’s first 4K QD-OLED gaming monitor, delivering infinite contrast, Dolby Vision HDR, and blazing fast 240Hz refresh rates.',
    features: ['4K QD-OLED Panel', '240Hz Refresh Rate', '0.03ms GtG Response', 'Dolby Vision HDR'],
    reviews: [
      { author: 'Kevin L.', rating: 5, comment: 'Crystal clear and fast. Great for my dual monitor setup.' }
    ]
  },
  {
    id: 8, name: 'Apple AirPods Pro 2', price: 249.00,
    category: 'Audio', badge: 'New',
    image: 'images/airpods_pro_2.png',
    gallery: ['images/airpods_pro_2.png'],
    desc: 'Pro-level Active Noise Cancellation, Adaptive Audio, USB-C.',
    longDesc: 'AirPods Pro 2 feature up to 2x more Active Noise Cancellation, plus Adaptive Audio that dynamically blends Transparency mode and ANC to tailor your listening experience to your environment.',
    features: ['H2 Apple Silicon', 'Next-level ANC', 'Adaptive Audio', 'MagSafe Charging Case (USB-C)'],
    reviews: [
      { author: 'Jessica F.', rating: 5, comment: 'Super comfortable and the sound is surprisingly deep.' }
    ]
  },
  {
    id: 9, name: 'Valve Steam Deck OLED', price: 549.00,
    category: 'Gaming', badge: 'Hot',
    image: 'images/steam_deck.png',
    gallery: ['images/steam_deck.png'],
    desc: '7.4" HDR OLED, 512GB NVMe SSD, better battery.',
    longDesc: 'The definitive portable PC gaming experience just got better. Featuring a stunning 7.4-inch HDR OLED screen, the Steam Deck OLED offers infinitely deeper blacks and striking colors. The new battery provides up to 50% more life so you can play longer.',
    features: ['7.4" HDR OLED Display', '512GB NVMe SSD', 'Wi-Fi 6E', 'Enhanced Battery Life'],
    reviews: [
      { author: 'Alex M.', rating: 5, comment: 'The OLED screen makes old games look completely brand new.' }
    ]
  },
  {
    id: 10, name: 'Nintendo Switch OLED', price: 349.99,
    category: 'Gaming', badge: '',
    image: 'images/switch_oled.png',
    gallery: ['images/switch_oled.png'],
    desc: '7-inch OLED screen, 64GB storage, enhanced audio.',
    longDesc: 'Play at home on the TV or on-the-go with a vibrant 7-inch OLED screen. The Nintendo Switch OLED model features a wide adjustable stand, a dock with a wired LAN port, and enhanced audio.',
    features: ['7-inch OLED Screen', 'Wide Adjustable Stand', 'Wired LAN Port in Dock', '64GB Internal Storage'],
    reviews: [
      { author: 'Brian T.', rating: 5, comment: 'Vibrant screen totally changes the portable experience.' }
    ]
  },
  {
    id: 11, name: 'Google Pixel 8 Pro', price: 999.00,
    category: 'Phones', badge: 'New',
    image: 'images/phone_main.png',
    gallery: ['images/phone_main.png'],
    desc: 'Google Tensor G3, Pro-level cameras, 7 years of updates.',
    longDesc: 'Engineered by Google, the Pixel 8 Pro is the smartest and most powerful Pixel yet. With the new Google Tensor G3 chip, it brings cutting-edge AI features, pro-level cameras, and an unprecedented 7 years of OS updates.',
    features: ['Google Tensor G3', 'Pro-level Triple Camera', 'Super Actua Display', 'Thermometer Sensor'],
    reviews: [
      { author: 'Sarah K.', rating: 4, comment: 'The AI photo editing is like magic. Battery is decent.' }
    ]
  },
  {
    id: 12, name: 'Apple Mac Studio (M2 Ultra)', price: 3999.00,
    category: 'Desktops', badge: 'Pro',
    image: 'images/console_side.png',
    gallery: ['images/console_side.png'],
    desc: '24-core CPU, 60-core GPU, 64GB memory, 1TB SSD.',
    longDesc: 'Empower your studio with the astronomical performance of the M2 Ultra. Mac Studio is a breakthrough personal computer that fits on your desk, offering massive performance, extensive connectivity, and boundary-pushing capabilities for the most demanding workflows.',
    features: ['Apple M2 Ultra Chip', '64GB Unified Memory', 'Up to 22 Streams of 8K ProRes', 'Extensive I/O Ports'],
    reviews: [
      { author: 'Creative_Director', rating: 5, comment: 'It renders 3D animations instantly. Worth every penny.' }
    ]
  },
  {
    id: 13, name: 'Bose QuietComfort Ultra', price: 429.00,
    category: 'Audio', badge: '',
    image: 'images/headphones_main.png',
    gallery: ['images/headphones_main.png'],
    desc: 'Spatial audio, world-class ANC, 24 hr battery.',
    longDesc: 'Step into a new dimension of audio. The QuietComfort Ultra headphones feature immersive spatial audio that creates an unprecedented acoustic experience. CustomTune technology auto-adjusts sound to your ears.',
    features: ['Immersive Spatial Audio', 'CustomTune Tech', 'World-Class ANC', '24-Hour Battery Life'],
    reviews: [
      { author: 'John L.', rating: 5, comment: 'The spatial audio blew my mind. Much better than the old QC 45s.' }
    ]
  },
  {
    id: 14, name: 'Samsung Odyssey OLED G9', price: 1799.99,
    category: 'Displays', badge: 'Hot',
    image: 'images/monitor_main.png',
    gallery: ['images/monitor_main.png'],
    desc: '49" Super Ultrawide, 240Hz, 0.03ms, OLED.',
    longDesc: 'Immerse yourself completely. The Odyssey OLED G9 offers a massive 49-inch curved super ultrawide display. With Samsung OLED technology, experience infinite contrast, alongside an ultra-fast 240Hz refresh rate and 0.03ms response time for a seamless gaming edge.',
    features: ['49" Curved OLED', 'Dual QHD Resolution', '240Hz Refresh', '0.03ms Response Time'],
    reviews: [
      { author: 'GamerDudee', rating: 5, comment: 'My whole field of vision is covered. It’s absolutely incredible.' }
    ]
  },
  {
    id: 15, name: 'Meta Quest 3', price: 499.00,
    category: 'Wearables', badge: 'New',
    image: 'images/smartwatch_main.png',
    gallery: ['images/smartwatch_main.png'],
    desc: 'Breakthrough mixed reality, pancake lenses, Snapdragon XR2 Gen 2.',
    longDesc: 'Transform your home into a boundless playground. Meta Quest 3 is our most powerful headset yet, featuring breakthrough mixed reality that seamlessly blends virtual elements with your physical space.',
    features: ['High-Fidelity Mixed Reality', 'Pancake Lenses', 'Snapdragon XR2 Gen 2', 'TrueTouch Haptics'],
    reviews: [
      { author: 'VRfanatic', rating: 5, comment: 'The passthrough quality is astonishing. Beats the Quest 2 by a mile.' }
    ]
  }
];
...
// ===== AUTH PAGES (Firebase Magic Link) =====
let currentAuthMode = 'signup';
let usernameDebounceTimer = null;

function renderLogin() {
  const isMagicLink = window.fbIsSignInLink && window.fbIsSignInLink();
  const cachedEmail = localStorage.getItem('emailForSignIn');

  // Handle Magic Link Verification Case
  if (isMagicLink && !cachedEmail) {
    return `
      <div class="page-transition auth-page" style="display: flex; align-items: center; justify-content: center; min-height: 80vh;">
        <div class="auth-container reveal auth-confirm-mode">
          <div class="auth-icon-header" style="text-align: center; margin-bottom: 2rem;">
            <div class="auth-icon-circle" style="width: 60px; height: 60px; background: rgba(59, 130, 246, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; border: 1px solid var(--accent-light);">
              <svg viewBox="0 0 24 24" width="30" height="30" stroke="var(--accent-light)" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
            </div>
          </div>
          <h2 class="auth-title">Verify Your Identity</h2>
          <p class="auth-subtitle">Welcome back. Please confirm your email to complete the secure handshake.</p>
          
          <form class="auth-form" onsubmit="event.preventDefault(); handleConfirmMagicLink(this);">
            <div class="input-group">
              <label>Confirmation Email</label>
              <input type="email" id="confirm-email" placeholder="name@email.com" class="boutique-input" required autofocus>
            </div>
            <button type="submit" class="btn-primary auth-submit" id="confirm-btn">Enter Portal →</button>
          </form>
          
          <p class="auth-footer" style="margin-top: 2rem;"><a href="#/login" onclick="localStorage.removeItem('emailForSignIn'); location.reload();" style="color: var(--text-muted); font-size: 0.85rem;">Didn't get a link? Start over</a></p>
        </div>
      </div>
    `;
  }
    ...
    <div class="page-transition auth-page" style="display: flex; align-items: center; justify-content: center; min-height: 80vh;">
      <div class="auth-container reveal">
        ...
        <div class="auth-content-slide">
            ...
            <form class="auth-form" id="magic-link-form" onsubmit="event.preventDefault(); handleMagicLink(this);">
              ${currentAuthMode === 'signup' ? `
              <div class="input-group">
                <label>Boutique Username</label>
                <div class="input-wrapper-glow">
                  <input type="text" name="username" id="login-username" placeholder="TechEnthusiast_26" required autofocus oninput="debouncedUsernameCheck(this.value)">
                </div>
                <div id="username-error" class="status-msg error-msg" style="display: none;"> Identity already claimed. </div>
                <div id="username-success" class="status-msg success-msg" style="display: none;"> Identity Available ✧ </div>
              </div>
              ` : ''}
              <div class="input-group">
                <label>Secure Email</label>
                <div class="input-wrapper-glow">
                  <input type="email" name="email" id="login-email" placeholder="name@email.com" required ${currentAuthMode === 'signin' ? 'autofocus' : ''}>
                </div>
              </div>
              <button type="submit" class="btn-primary auth-submit" id="submit-magic">Dispatch Magic Link →</button>
            </form>
            
            <div id="auth-status-msg" class="auth-pending-notice" style="display: none;">
              <div class="loader-dots"><span></span><span></span><span></span></div>
              <p>Magic Link dispatched! Check your inbox to enter the vault.</p>
            </div>
            
            <p class="auth-footer" style="margin-top: 2.5rem; font-size: 0.8rem; color: var(--text-muted);">
                The high-security Magic Link is passwordless and biometric-ready.
            </p>
        </div>
      </div>
    </div>
...
window.debouncedUsernameCheck = (val) => {
  ...
  usernameDebounceTimer = setTimeout(() => checkUsername(val), 400);
};

window.checkUsername = async (val) => {
  const errorEl = document.getElementById('username-error');
  const successEl = document.getElementById('username-success');
  const btn = document.getElementById('submit-magic');
  ...
  const exists = await window.fbCheckUsername(val);
  if (exists) {
...
window.handleConfirmMagicLink = async (form) => {
  ...
  try {
    ...
    const result = await window.fbHandleLogin(email);
    if (result.success) {
      showToast('Welcome to the elite tier, ' + window.currentUser.name);
      window.location.hash = '#/';
    }
  } catch (err) {
...
window.handleMagicLink = async (form) => {
  ...
  if (!window.fbSendLoginLink) {
    showToast('Vault security initializing... try again in 3 seconds');
    return;
  }

  try {
    btn.disabled = true;
    btn.textContent = 'Allocating Link...';

    // Final defensive check for username uniqueness in signup mode
    if (currentAuthMode === 'signup' && username) {
      const taken = await window.fbCheckUsername(username);
      if (taken) {
        showToast('Identity Error: This username was just claimed!');
        btn.disabled = false;
        btn.textContent = 'Dispatch Magic Link →';
        return;
      }
    }

    await window.fbSendLoginLink(email, username);
    showToast('✨ Security link dispatched! Check your email.');

    if (formEl) formEl.style.opacity = '0';
    setTimeout(() => {
  ...
  return `
    <div class="page-transition settings-page" style="display: flex; align-items: center; justify-content: center; min-height: 80vh;">
      <div class="auth-container reveal">
        ...
        <form class="auth-form" onsubmit="event.preventDefault(); handleUpdateUsername(this);">
          <div class="input-group">
          ...
          <div class="input-group" style="margin-top: 2rem;">
            ...
            <input type="text" id="new-username" name="username" placeholder="${user.name}" required>
          </div>
...
window.handleUpdateUsername = async (form) => {
  ...
  try {
    ...
    // Use the global Firebase update logic
    if (window.currentUser) {
      // Attempt to reserve in Firestore first
      const user = window.currentUser;

      // This logic should ideally be in a window function set up in index.html 
      // but since we are simulating the identity vault check at login 
      // we'll update the local session and toast for now.
      // real Firebase profile update is handled by onAuthStateChanged synchronization.

      const localUser = JSON.parse(localStorage.getItem('tw_user'));
      localUser.name = username;
      localStorage.setItem('tw_user', JSON.stringify(localUser));
      window.currentUser = localUser;

      setTimeout(() => {
        updateUserUI();
        showToast('✨ Identity successfully updated across the boutique cloud.');
        window.location.hash = '#/';
      }, 800);
    }
  } catch (err) {
...
// ===== INIT & MAGIC LINK CHECK =====
async function checkAuthLink() {
  if (window.fbIsSignInLink && window.fbIsSignInLink()) {
    const result = await window.fbHandleLogin();
